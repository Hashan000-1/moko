              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, HASHAN-MD User!* 👋🏻

Thanks for using *HASHAN-MD* — your session has been successfully created!
...
externalAdReply: {
title: "HASHAN-MD-V1",
thumbnailUrl: "https://files.catbox.moe/sn20tl.jpg",
